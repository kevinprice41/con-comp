package com.prizyp.cc.comp.data.twitter;
...
public class TwitterClient {
    ...
    private String twitter_consumer_key = "U2gze4WtTbfLk3jnqWaaw";
    private String twitter_consumer_secret = "njMcxIVNkFc8t8XPecCZKF0f3QVZz8y6FkLsqLZtc";
    ...
    public JSONObject startTwitterAuthentication()
    {
        ...
        String parameter_string = "oauth_consumer_key=" + twitter_consumer_key + "&oauth_nonce=" + oauth_nonce + "&oauth_signature_method=" + oauth_signature_method + "&oauth_timestamp=" + oauth_timestamp + "&oauth_version=1.0&oauth_callback=oob";
        ...
        try{ // jsonexception block
            try
            {
                ...
                request2.setEntity( new StringEntity("application/x-www-form-urlencoded"));
    ...
    public JSONObject getTwitterAccessTokenFromAuthorizationCode(String verifier_or_pin, String oauth_token)
    {
        ...
        try{
            try {
                ...
                request2.setEntity( new StringEntity("oauth_verifier=" + encode(verifier_or_pin), "application/x-www-form-urlencoded"));
    ...
    public JSONObject updateStatus(String access_token, String access_token_secret, String text)
    {
        ...
        try
        {
            try
            {
                ...
                request2.setEntity( new StringEntity("status=" + encode(text), "application/x-www-form-urlencoded"));
                request2.setParams(params);
                request2.addHeader("Authorization", authorization_header_string);
                httpexecutor.preProcess(request2, httpproc, context);
                HttpResponse response2 = httpexecutor.execute(request2, conn, context);
    ...
    public static void main(String[] args) {
        ...
        JSONObject response = twitter.searchTweets("", "170212551-biO37n2kdeWz0lcu7jiBRVrez38rQaZ3jwATM8xk", "y0K8L5EQp1bw9yPg3wKA7j3crjTP3euwA1JyfqwqL20");
